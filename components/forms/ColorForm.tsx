        ...
        <div>
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              onChange={handleChange}
              className={`block flex-1 rounded-lg border-gray-200 shadow-sm sm:text-sm py-2 px-3 bg-white text-gray-900 focus:ring-0 focus:border-gray-500 transition-colors ${errors.hex_code ? 'border-red-500' : ''
                }`}
              placeholder="#RRGGBB"
            />
            <div
          ...
          {errors.hex_code && (
            <p className="mt-1 text-sm text-red-600">{errors.hex_code}</p>
          )}
        </div>
