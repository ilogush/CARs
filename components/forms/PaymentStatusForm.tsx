      ...
      <form id="payment-status-form" onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            className={`block w-full rounded-lg border-gray-200 shadow-sm sm:text-sm py-2 px-3 bg-white text-gray-900 focus:ring-0 focus:border-gray-500 transition-colors ${errors.name ? 'border-red-500' : ''
              }`}
        ...
        <div>
          ...
          <select
            ...
            value={formData.value}
            onChange={handleChange}
            className={`block w-full rounded-lg border-gray-200 shadow-sm sm:text-sm py-2 px-3 bg-white text-gray-900 focus:ring-0 focus:border-gray-500 transition-colors ${errors.value ? 'border-red-500' : ''
              }`}
          >
