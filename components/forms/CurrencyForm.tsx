      ...
      <form id="currency-form" onSubmit={handleSubmit} className="space-y-4">
        ...
        >
          <input
            ...
            maxLength={3}
            className={`${inputBaseStyles} font-mono uppercase ${errors.code ? 'border-red-500' : ''}`}
            placeholder="USD"
          />
        </FormField>
        ...
        >
          <input
            ...
            value={formData.name}
            onChange={handleChange}
            className={`${inputBaseStyles} ${errors.name ? 'border-red-500' : ''}`}
        ...
        >
          <input
            ...
            onChange={handleChange}
            maxLength={10}
            className={`${inputBaseStyles} text-lg ${errors.symbol ? 'border-red-500' : ''}`}
            placeholder="$"
          />
        </FormField>
