...
export default function ClientForm({
  ...
  const [passportNumber, setPassportNumber] = useState(initialData?.user?.passport_number || initialData?.client_profile?.passport_number || initialData?.passport_number || '')
  ...
  const [address, setAddress] = useState(initialData?.client_profile?.address || initialData?.address || '')
    ...
    <div>
      ...
      <div className="overflow-hidden">
        <form id={formId} onSubmit={handleSubmit} className="space-y-6">
          ...
          {/* Row 1: Passport Number, First Name, Last Name, Citizenship */}
          ...
          {/* Row 2: City, Gender, Email, Password OR Confirm Password */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div>
              <label className="block text-xs text-gray-600 mb-1">
                City
          ...
          {/* Row 3: Phone, WhatsApp, Telegram, Email OR Confirm Password */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div>
              <label className="block text-xs text-gray-600 mb-1">
                Phone *
